...
function normalizeLineItem({ node: { id , title , variant , quantity  }  }) {
    ...
    return {
        ...
        variant: {
            ...
            image: {
                url: (variant == null ? void 0 : (ref = variant.image) == null ? void 0 : ref.url) || "/product-img-placeholder.svg"
            },
            requiresShipping: (variant == null ? void 0 : variant.requiresShipping) ?? false,
            price: variant == null ? void 0 : (ref1 = variant.priceV2) == null ? void 0 : ref1.amount,
            listPrice: variant == null ? void 0 : (ref2 = variant.compareAtPriceV2) == null ? void 0 : ref2.amount
        },
        path: String(variant == null ? void 0 : (ref3 = variant.product) == null ? void 0 : ref3.handle),
        discounts: [],
