...
export function normalizeCart(order) {
    ...
    return {
        ...
        customerId: (ref = order.customer) == null ? void 0 : ref.id,
        lineItems: (ref1 = order.lines) == null ? void 0 : ref1.map((l)=>{
            var ref, ref1;
            return {
                id: l.id,
                ...
                variant: {
                    ...
                    image: {
                        url: ((ref1 = l.featuredAsset) == null ? void 0 : ref1.preview) + "?preset=thumb" || ""
                    },
