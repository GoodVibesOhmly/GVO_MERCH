...
export function normalizeProduct(productNode) {
    const { entityId: id , productOptions , prices , path , id: _ , options: _0 ,  } = productNode;
    return update(productNode, {
        ...
        options: {
            $set: productOptions.edges ? productOptions == null ? void 0 : productOptions.edges.map(normalizeProductOption) : []
        },
        brand: {
            $apply: (brand)=>{
